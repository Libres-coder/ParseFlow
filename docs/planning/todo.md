...
### v1.7.0 - 批量处理（2025-12-17）
- [x] 并行处理多个文件
- [x] 目录批量扫描
- [x] batch_extract, batch_search 工具

### v1.6.0 - 语义搜索（2025-12-17）
- [x] AI 向量嵌入搜索
- [x] 文档智能索引
- [x] semantic_index, semantic_search 工具

### v1.5.0 - PDF 操作（2025-12-17）
- [x] PDF 合并 (merge_pdf)
- [x] PDF 拆分 (split_pdf)
- [x] PDF 页面提取 (extract_pdf_pages)

### v1.4.0 - 加密 PDF（2025-12-17）
- [x] 密码保护 PDF 支持
- [x] password 参数

### v1.3.0 - OCR 支持（2025-12-16）
- [x] 图片文字识别 (12 种语言)
- [x] extract_ocr, search_ocr 工具

### v1.2.0 - PowerPoint（2025-12-16）
- [x] PPT 文本提取和搜索

### v1.1.0 - Office 支持（2025-12-15）
- [x] Word (docx) 支持
- [x] Excel (xlsx/xls) 支持
