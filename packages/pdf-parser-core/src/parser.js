...
export class PDFParser {
     ...
     * 提取完整文本
     */
    async extractText(path, options) {
     ...
     */
    async extractImages(path, outputDir, options) {
        const buffer = this.readFile(path);
